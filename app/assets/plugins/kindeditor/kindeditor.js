		...
		iframe.bind('load', function() {
			...
			try {
				...
				if (!str) {
					...
					if (self.form[0].title) {
						data.title = self.form[0].title.value;
					}
					if (self.form[0].width) {
						data.width = self.form[0].width.value;
					}
					if (self.form[0].height) {
						data.height = self.form[0].height.value;
					}
					if (self.form[0].align) {
						data.align = self.form[0].align.value;
					}
				}
			}
			if (data) {
